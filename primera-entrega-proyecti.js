...
if (cantidadProducto == 0) {
    alert(nombre.toUpperCase() + " gracias por visitar nuestra tienda ");
} else {
    ...
    for (const compra of producto) {
        let li = document.createElement('li')
        li.innerHTML = (compra.nombre + " compro " + compra.clase + " de marca " + compra.marca + " a " + compra.precio)
    ...
    switch (formaPago) {
        case "1":
            ...
            p.innerHTML = "La compra total de " + nombre.toUpperCase() + " es de " + precioEfectivo(precioTotal, descuento(precioTotal)) + " por pagar en efectivo"
        ...
        case "2":
            ...
            span.innerHTML = "La compra total de " + nombre.toUpperCase() + " es de " + precioTarjeta(precioTotal, recargo(precioTotal)) + " por pagar con tarjeta"
